  ...
  menu: [
    {
      ...
      submenu: [
        { label: localized('About QGMail'), command: 'application:about' },
        ...
        { type: 'separator' },
        { label: localized('Hide QGMail'), command: 'application:hide' },
...

    {
      ...
      submenu: [
        { label: localized('QGMail Help'), command: 'application:view-help' },
        { type: 'separator' },
        { label: localized('Getting Started Guide'), command: 'application:view-getting-started' },
        { label: localized('QGMail Community'), command: 'application:view-community' },
      ],
    },
  ],
};
