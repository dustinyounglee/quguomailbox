...
const Steps = [
  ...
  },
  {
    ...
    description: localized(
      'With activity tracking, you’ll know as soon as someone reads your message. Sending to a group? QGMail shows you which recipients opened your email so you can follow up with precision.'
    ),
    x: 12.8,
    y: 1,
    xDot: 15,
  ...
  },
  {
    ...
    description: localized(
      'Snooze emails to return at any time that suits you. Schedule messages to send at the ideal time. QGMail makes it easy to control the fabric of spacetime!'
    ),
    x: 5.5,
    y: 23.3,
    xDot: 10,
