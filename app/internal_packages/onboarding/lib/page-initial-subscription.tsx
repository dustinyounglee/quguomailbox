  ...
  render() {
    return (
      <div className="page opaque initial-subscription" style={{ width: 900, height: 620 }}>
        <h1 style={{ paddingTop: 100 }}>{localized(`Go further with QGMail Pro`)}</h1>
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          <div className="basic-explanation">
            ...
            <p>
              {localizedReactFragment(
                `If you enjoy QGMail, upgrade to QGMail Pro from %@ to enable all these great features permanently:`,
