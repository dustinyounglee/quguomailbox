...
const ProTourFeatures = [
  {
    ...
    text: localized(
      `Never forget to follow up! QGMail reminds you if your messages haven't received replies.`
    ),
  },
  {
...
> {
        ...
        <div className="row padded">
          <div style={{ display: 'flex', alignItems: 'flex-start' }}>
            <div className="basic-explanation" style={{ display: 'flex' }}>
              {localizedReactFragment(
                `You are not signed in to QGMail. Link the app to a free QGMail ID to use great free features like send later and snoozing, or upgrade to QGMail Pro for unlimited message translation and more.`
              )}
              <div
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start' }}>
          <div className="basic-explanation">
            {localizedReactFragment(
              ...
              <strong>{localized('QGMail Basic')}</strong>
            )}
            {process.platform === 'linux' && (
              <span>
                {localizedReactFragment(
                  `QGMail is independent %@ software, and subscription revenue allows us spend time maintaining and improving the product.`,
            ...
            {localizedReactFragment(
              ...
              <a onClick={onLearnMore}>{localized('QGMail Pro')}</a>
            )}
          ...
          <div className="subscription-actions">
            ...
            <OpenIdentityPageButton
              label={localized('Get QGMail Pro')}
              path="/payment"
  ...
  _renderPaidPlan(planName: string, effectivePlanName: string) {
    ...
    const unpaidNote = effectivePlanName !== planName && (
      <p>
        {localized(
          `Note: Due to issues with your most recent payment, you've been temporarily downgraded to QGMail %@. Click 'Billing' below to correct the issue.`,
          effectivePlanName
        )}
      </p>
    );
      ...
      <div className="row padded">
        <div>
          {localizedReactFragment(
            ...
            <strong style={{ textTransform: 'capitalize' }}>{`QGMail ${planDisplayName}`}</strong>,
...
const ExploreMailspringPro: React.FunctionComponent = () => (
  <>
    <div className="feature-explore-title">{localized('Explore QGMail Pro')}</div>
